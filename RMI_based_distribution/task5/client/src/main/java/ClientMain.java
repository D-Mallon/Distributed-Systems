...
public class ClientMain {
	...
	public static void main(String[] args) throws RemoteException {
		...
		// Print a message to indicate that this file is being executed.
		System.out.println("testing Client Main.java file being called");
			...
			try {
				...
				System.out.println("Trouble is here: " + e);
			}

...
public class QuotationServiceUnitTest {
     ...
     * We're publishing the GAQService as a web service here.
     */
    @BeforeClass
    public static void setup() {
        // Publish the GAQService at the specified URL
    ...
    public void connectionTest() throws Exception {
        ...
        System.out.println("Running Girls_connectionTest");

        // Define the WSDL URL for the QuotationService
        URL wsdlUrl = new URL("http://localhost:9003/quotations?wsdl");
